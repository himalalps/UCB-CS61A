...
def count_coins(change):
    ...
    def count(change, large):
        if change == 0:
            ...
            return count(change - large, large) + count(change, next_smaller_coin(large))
...
def beaver(f):
    (lambda g: g(g(g(g(g(f))))))((lambda h: lambda: h() or h() or h() or h()))()
...
def b(f):
    ...
    """
    (lambda g: g(g(g(g(g(g(f)))))))(lambda h: h() or h())()
